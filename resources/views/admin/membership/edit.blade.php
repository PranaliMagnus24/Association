  ...
  <main id="main" class="main">
    ...
    <div class="container">
        ...
        <a href="{{ url('admin/membershipform')}}" class="btn btn-primary">Back</a>
          ...
          <div class="card">
            <div class="card-body">
            <h5 class="card-title">Edit Member Profile</h5>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4 col-lg-4">
                ...
                <input id="birth" name="date_birth" type="date" class="form-control" placeholder="Date of Birth" max="{{ $maxDate }}" value="{{$data->date_birth}}">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4 col-lg-4">
                ...
                <input id="profilePicture" name="profile_pic" type="file" class="form-control" accept="image/*" value="{{$data->profile_pic}}">
                @error('profile_pic')
    ...
    <button type="submit" value="Update profile" class="btn btn-primary">Save</button>
</div>
