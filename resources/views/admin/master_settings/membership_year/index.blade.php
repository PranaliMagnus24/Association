    ...
    <div class="pagetitle">
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Membership year list</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<div class="search-bar">
      <form class="search-form d-flex align-items-center" method="get" action="{{url('membershipyear_search')}}">
        @csrf
        <input type="text" name="search" placeholder="Search" title="Enter search keyword">
        <button type="submit" title="Search"><i class="bi bi-search"></i></button>
      </form>
      <a href="{{ route('membershipyear.add')}}" class="btn btn-primary">+</a>
    </div><!-- End Search Bar -->
    ...
    <div class="card">
        <div class="card-body">
            ...
            <table class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Membership Year</th>
            ...
            <tr>
                ...
                <td>{{$data->membership_year}}&nbsp;{{$data->default_year}}</td>
                <td>{{$data->membership_fee}}</td>
                <td>{{$data->status}}</td>
