        ...
        <a href="{{ route('committee.index')}}" class="btn btn-primary">Back</a>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" method="POST" action="{{ route('committee.store') }}" enctype="multipart/form-data">
              @csrf
              <div class="row">
              <div class="col-md-6">
                <label for="inputName5" class="form-label">Member Name</label>
                  <input type="text" class="form-control" name="member_name" placeholder="Your Name">
                </div>
               ...
               <select name="position" id="position" class="form-control">
                ...
                <textarea class="form-control" placeholder="Description" id="floatingTextarea" style="height: 100px;" name="summary"></textarea>
                </div>
