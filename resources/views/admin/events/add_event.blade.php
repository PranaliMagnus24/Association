          ...
          <div class="card">
            ...
            <label for="inputName5" class="col-md-4 col-lg-3 col-form-label">Introduction</label>
                ...
                <div id="quill-editor" class="mb-3" style="height: 150px;">
                    ...
                    <textarea rows="3" class="mb-3 d-none" name="introduction" id="quill-editor-area"></textarea>
               </div>
            </div>
            ...
            <div class="col-md-8 col-lg-3">
              ...
              <div class="col-md-8 col-lg-3">
              <input type="datetime-local" class="form-control" name="eventenddatetime">
            </div>
            </div>
            ...
            <div class="col-md-8 col-lg-3">
                <input type="datetime-local" class="form-control" name="registerstartdatetime">
            </div>
            <label for="inputName5" class="col-md-4 col-lg-3 col-form-label">Register End Date & Time</label>
            <div class="col-md-8 col-lg-3">
                <input type="datetime-local" class="form-control" name="registerenddatetime" placeholder="Event Title">
             </div>
            </div>
            <div class="row mb-3">
                <!-- Dropdown for Type -->
