...
<div class="container">
    ...
    <div class="card">
            ...
            <form class="row g-3" method="POST" action="{{ route('job.store') }}" enctype="multipart/form-data">
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-8 col-lg-9">
                    ...
                    <textarea rows="3" class="mb-3 d-none" name="job_desc" id="quill-editor-area" placeholder="Write here"></textarea>
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-md-8 col-lg-3">
                    <input type="text" name="vacancy" id="vacancy" class="form-control" placeholder="Vacancy">
                </div>
                <label for="exp_req" class="col-md-4 col-lg-3 col-form-label">Experience Required</label>
            <div class="col-md-8 col-lg-3">
                <input type="text" name="exp_req" id="exp_req" class="form-control" placeholder="Experience Required">
            </div>
            </div>
            <div class="row mb-3">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-8 col-lg-9">
                <textarea name="skill" id="skill" class="form-control" placeholder="Add skill's here" style="height: 100px;"></textarea>
            </div>
            </div>
            <div class="row mb-3">
            <label for="salary" class="col-md-4 col-lg-3 col-form-label">Salary</label>
                <div class="col-md-8 col-lg-3">
                    <input type="text" name="salary" id="salary" class="form-control" placeholder="add salary">
                </div>
            </div>
