                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <div class="section-title">
                            <h2>The aims of Muslim Industrialists and Merchants Association</h2>
                        </div>
                    </div>
                </div>
                <!--== Section Title End ==-->
                ...
                <div class="row text-center text-sm-left mt-4">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        ...
                        <img src="{{asset('homecss/assets/images/responsibility/02.png')}}" alt="Responsibility">
                            <h4> Policy Feedback</h4>
                            <p>Providing expert feedback on proposed legislation and regulations that impact</p>
                        </div>
                    </div>
                    <!--== Single Responsibility End ==-->
                </div>
