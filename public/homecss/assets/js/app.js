...
const swiper = new Swiper('.slider-wrapper', {
  ...
  $(document).ready(function () {
    ...
    $(document).on("click", ".section1 img", function () {
        $(".lightbox").fadeIn(300);
        $(".lightbox").append("<img src='" + $(this).attr("data-mdb-img") + "' alt='" + $(this).attr("alt") + "' />");
        $(".filter1").css("background-image", "url(" + $(this).attr("data-mdb-img") + ")");
    ...
    $(document).on("click", ".arrowr1", function () {
        var imgSrc = $(".lightbox img").attr("src");

        var search = $(".section1").find("img[data-mdb-img$='" + imgSrc + "']");
        var newImage = search.next().attr("data-mdb-img");
    ...
    $(document).on("click", ".arrowl1", function () {
        var imgSrc = $(".lightbox img").attr("src");
        var search = $(".section1").find("img[data-mdb-img$='" + imgSrc + "']");
        var newImage = search.prev().attr("data-mdb-img");
        $(".lightbox img").attr("src", newImage);
        $(".filter1").css("background-image", "url(" + newImage + ")");
